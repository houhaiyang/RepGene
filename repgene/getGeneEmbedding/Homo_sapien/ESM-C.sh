...
# 加载环境配置
source /home/share/xxx/home/xxx/bashrc/ESM-C-py310-torch241-cu118.bashrc
...
python /home/share/xxx/home/xxx/method/ESM-C/faa2emb_CLS-2.py \
    --input Homo_sapiens/ncbi_dataset/data/GCF_000001405.40/protein.faa \
    --outdir embeddings/proteins/

# mergeEmbeddings
cd ${data_dir}
python /home/share/xxx/home/xxx/method/ESM-C/merge_emb.py \
    --input Homo_sapiens/ncbi_dataset/data/GCF_000001405.40/protein.faa \
