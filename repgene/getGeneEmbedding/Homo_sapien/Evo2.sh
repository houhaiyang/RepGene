...
# 加载环境配置
source /home/share/huadjyin/home/houhaiyang/bashrc/EVO2.bashrc

data_dir='/home/share/huadjyin/home/houhaiyang/project/RepGene/data/species/Homo_sapiens/'

# getEmbeddings
cd /home/share/huadjyin/home/houhaiyang/method/Evo2/evo2
# 使用 Evo 生成DNA序列的 Embeddings
python ./test/test_evo2_Embeddings_hou.py \
  --model_name evo2_7b \
   --local_model_path /home/share/huadjyin/home/houhaiyang/HF_HOME/transformers/arcinstitute/evo2_7b/evo2_7b.pt \
...
# mergeEmbeddings
cd ${data_dir}
python /home/share/huadjyin/home/houhaiyang/method/Evo2/evo2/test/mergeEmbeddings.py --input_dir ./embeddings/DNA --output_file ./embeddings/DNA_merged_embeddings.csv.gz
